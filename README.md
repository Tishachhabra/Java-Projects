...
A comprehensive Java desktop project which consists of Java GUI libraries (AWT and Swing) with MySQL integration for user-friendly interface and more efficient storage. The target users of the project are the librarian and student/borrower of the book. The whole project is mainly divided into Admin Section, Library Section and Student section. It efficiently manages student & book records, issuance and return details.
...
## Installing
Eclipse IDE can be downloaded from [Windows](https://www.eclipse.org/downloads/) and Java runtime environment for [Windows](https://www.java.com/en/download/).
## Functionalities
